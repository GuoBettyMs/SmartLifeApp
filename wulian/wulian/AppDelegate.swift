...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ThingSmartSDK.sharedInstance().appGroupId = AppKey.groupId
        //配置 ThingSmartHomeKit, 初始化 SDK
        ...
        // Set your Matter Group ID if your app supports Matter
        ThingSmartMatterActivatorConfig.setMatterKey(AppKey.groupId)

        // Load last current family info
        ThingSmartFamilyBiz.sharedInstance().launchCurrentFamily(withAppGroupName: "my_app_group_name")
        
    #if DEBUG
        ThingSmartSDK.sharedInstance().debugMode = true //开启 Debug 模式
    #else
    #endif
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "wulian")
