...
//4G Gateway
@property (nonatomic, copy) NSString *thing4GGatewayTipIconUrl;
@property (nonatomic, copy) NSString *thing4GGatewayTip;
@property (nonatomic, copy) NSString *thing4GGatewayAddBtText;
@property (nonatomic, copy) NSString *thing4GGatewayHelpUrl;
@property (nonatomic, copy) NSString *thing4GGatewayVideoUrl;

// button text
@property (nonatomic, copy) NSString *radioViewDetail; //单选框"查看详情"
@property (nonatomic, copy) NSString *guidePreStep; //辅助引导"上一步"
@property (nonatomic, copy) NSString *guideNextStep; // 辅助引导"下一步"
@property (nonatomic, copy) NSString *guideConfirm; // 辅助引导"确认"
@property (nonatomic, copy) NSString *singleStepHelpTip; // "重置设备帮助"
@property (nonatomic, copy) NSString *guideTopTitle; // 简单引导页 title
