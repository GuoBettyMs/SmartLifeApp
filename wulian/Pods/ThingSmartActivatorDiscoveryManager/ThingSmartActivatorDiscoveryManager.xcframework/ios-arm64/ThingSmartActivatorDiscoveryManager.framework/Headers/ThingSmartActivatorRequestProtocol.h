...
- (void)requestProductActiveSuccessConfigWithParam:(ThingActivatorProductActiveSuccessConfigRequestData *)param
                                           success:(void(^)(ThingActivatorProductActiveSuccessConfigResponseData *result))success
                                           failure:(ThingActivatorCallbackError)failure;
@end
