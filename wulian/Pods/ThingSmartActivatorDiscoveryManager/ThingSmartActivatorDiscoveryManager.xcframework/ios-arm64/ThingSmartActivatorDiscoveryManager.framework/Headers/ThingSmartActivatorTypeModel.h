...
typedef NS_ENUM(NSInteger,ThingActivatorBleActiveType){
    ThingActivatorBleActiveTypeDefault,  // Individual device activation
    ThingActivatorBleActiveTypeBatch, // Batch activation of devices
};
...
/// 4G Gateway
@interface ThingSmartActivatorTypeGateway4GModel: ThingSmartActivatorTypeModel
///Telecom operator
