...
typedef enum : NSUInteger {
    ...
    ThingSearchDeviceModelTypeBleWired, /// Bluetooth-wired dual-mode devices
    ...
    ThingSearchDeviceModelTypeMultimodeGateway, ///Multi-mode Gateway
...
typedef NS_OPTIONS(NSUInteger, ThingActivatorDeviceAbility) {
    ...
    ThingActivatorDeviceAbilityWifiList = (1 << 8), /// Wifi List capability,ble-wifi mode does not require WiFi information and returns a list of surrounding WiFi during the pairing process.
    ThingActivatorDeviceAbilityBleWired = (1 << 9), /// BLE Wired capability, ble-wired mode does not require WiFi information
    ThingActivatorDeviceAbilityBleWifi = (1 << 10), /// BLE Wifi capability
    ThingActivatorDeviceAbilityWired = (1 << 11),   /// Wired capability
};
