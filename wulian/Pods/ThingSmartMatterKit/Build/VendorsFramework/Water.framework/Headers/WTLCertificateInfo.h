...
@class WTLDistinguishedNameInfo;
...
@interface WTLCertificateInfo : NSObject <NSCopying>
 ...
 */
- (nullable instancetype)initWithTLVBytes:(WTLCertificateTLVBytes)bytes;
 ...
 * the same.
 */
@property (readonly) WTLDistinguishedNameInfo * issuer;

/**
 * The Distinguished Name of the entity represented by the certificate.
 */
@property (readonly) WTLDistinguishedNameInfo * subject;
...
NS_SWIFT_SENDABLE
API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4))
@interface WTLDistinguishedNameInfo : NSObject <NSCopying>
