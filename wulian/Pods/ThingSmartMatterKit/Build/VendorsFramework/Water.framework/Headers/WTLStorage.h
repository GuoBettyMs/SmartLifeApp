...
WTL_DEPRECATED("Please use WTLStorage",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
@protocol WTLPersistentStorageDelegate <WTLStorage>
@end
