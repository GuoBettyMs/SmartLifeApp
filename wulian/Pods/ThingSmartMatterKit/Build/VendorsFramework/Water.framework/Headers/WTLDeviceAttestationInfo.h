...
@interface WTLDeviceAttestationInfo : NSObject
 ...
 */
@property (nonatomic, copy, readonly) WTLTLVBytes elementsTLV;
/**
 ...
 */
@property (nonatomic, copy, readonly) WTLCertificateDERBytes deviceAttestationCertificate;
/**
 ...
 */
@property (nonatomic, copy, readonly) WTLCertificateDERBytes productAttestationIntermediateCertificate;
/**
...
- (instancetype)initWithDeviceAttestationChallenge:(NSData *)challenge
                                             nonce:(NSData *)nonce
                                       elementsTLV:(WTLTLVBytes)elementsTLV
                                 elementsSignature:(NSData *)elementsSignature
                      deviceAttestationCertificate:(WTLCertificateDERBytes)deviceAttestationCertificate
         productAttestationIntermediateCertificate:(WTLCertificateDERBytes)processAttestationIntermediateCertificate
                          certificationDeclaration:(NSData *)certificationDeclaration
                                      firmwareInfo:(NSData *)firmwareInfo;

@end

WTL_DEPRECATED("Please use WTLDeviceAttestationInfo",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
