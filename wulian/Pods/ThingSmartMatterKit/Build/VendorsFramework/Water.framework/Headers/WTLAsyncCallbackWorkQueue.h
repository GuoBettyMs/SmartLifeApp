...
@class WTLAsyncCallbackQueueWorkItem;

typedef void (^WTLAsyncCallbackReadyHandler)(id context, NSUInteger retryCount);

// WTLAsyncCallbackQueue high level description
//   The WTLAsyncCallbackQueue was made to call one readyHandler
...
//   - Create WTLAsyncCallbackQueueWorkItem object
//   - Create ready handler block (WTLAsyncCallbackReadyHandler)
...
//   - Call enqueueWorkItem on a WTLAsyncCallbackQueue

// A serial one-at-a-time queue for performing work items
@interface WTLAsyncCallbackWorkQueue : NSObject
