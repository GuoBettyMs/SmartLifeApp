...
@interface WTLCertificates : NSObject
 ...
 */
+ (BOOL)keypair:(id<WTLKeypair>)keypair matchesCertificate:(NSData *)certificate;
 ...
 */
+ (BOOL)isCertificate:(WTLCertificateDERBytes)certificate1 equalTo:(WTLCertificateDERBytes)certificate2;

/**
 * Generate a PKCS#10 certificate signing request from a WTLKeypair.  This can
 ...
 */
+ (WTLCertificateDERBytes _Nullable)convertMatterCertificate:(WTLCertificateTLVBytes)matterCertificate
    API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
...
@interface WTLCertificates (Deprecated)
...
+ (nullable NSData *)generateRootCertificate:(id<WTLKeypair>)keypair
                                    ...
                                    fabricId:(nullable NSNumber *)fabricId
                                       error:(NSError * __autoreleasing _Nullable * _Nullable)error
    WTL_DEPRECATED("Please use createRootCertificate:issuerID:fabricID:error:",  macos(13.0, 13.3),
...
+ (nullable NSData *)generateIntermediateCertificate:(id<WTLKeypair>)rootKeypair
                               ...
                               intermediatePublicKey:(SecKeyRef)intermediatePublicKey
                                            ...
                                            fabricId:(nullable NSNumber *)fabricId
                                               error:(NSError * __autoreleasing _Nullable * _Nullable)error
    WTL_DEPRECATED("Please use createIntermediateCertificate:rootCertificate:intermediatePublicKey:issuerID:fabricID:error:",
...
+ (nullable NSData *)generateCertificateSigningRequest:(id<WTLKeypair>)keypair
                                                 error:(NSError * __autoreleasing _Nullable * _Nullable)error
    WTL_DEPRECATED("Please use createCertificateSigningRequest:error:",  macos(13.0, 13.3), watchos(9.1, 9.4),
        tvos(16.1, 16.4));
