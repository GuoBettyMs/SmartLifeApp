...
WTL_DEPRECATED("ResponseHandler is not used",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
typedef void (^ResponseHandler)(id _Nullable value, NSError * _Nullable error);
WTL_DEPRECATED("Please use WTLStatusCompletion instead",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
typedef void (^StatusCompletion)(NSError * _Nullable error);
WTL_DEPRECATED(
    "Please use WTLSubscriptionEstablishedHandler instead",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
typedef void (^SubscriptionEstablishedHandler)(void);

typedef void (^WTLStatusCompletion)(NSError * _Nullable error);
typedef void (^WTLSubscriptionEstablishedHandler)(void);
 ...
 */
@interface WTLCluster : NSObject
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)new NS_UNAVAILABLE;
@end

@interface WTLCluster(Device)
- (WTLBaseDevice *)device;
@end
 ...
 */
@interface WTLWriteParams : NSObject <NSCopying>
 ...
 *    If not provided (i.e. nil passed for the WTLReadParams argument), will be
 *    treated as if a default-initialized object was passed in.
 */
@interface WTLReadParams : NSObject <NSCopying>
...
@property (nonatomic, assign, getter=shouldFilterByFabric)
    BOOL filterByFabric API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, copy, nullable) NSNumber * minEventNumber API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
 ...
 *    provided (i.e. nil passed for the WTLSubscribeParams argument), will be
 *    treated as if a default-initialized object was passed in.
 */
@interface WTLSubscribeParams : WTLReadParams
...
@property (nonatomic, assign, getter=shouldReplaceExistingSubscriptions)
    BOOL replaceExistingSubscriptions API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
...
@property (nonatomic, assign, getter=shouldResubscribeAutomatically)
    BOOL resubscribeAutomatically API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, copy) NSNumber * minInterval API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, copy) NSNumber * maxInterval API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
...
@property (nonatomic, assign, getter=shouldReportEventsUrgently)
    BOOL reportEventsUrgently API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));

/**
 * Initialize an WTLSubscribeParams.  Must provide a minInterval and
...
@interface WTLReadParams (Deprecated)

@property (nonatomic, copy, nullable) NSNumber * fabricFiltered WTL_DEPRECATED(
    "Please use filterByFabric",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));

@end

@interface WTLSubscribeParams (Deprecated)

@property (nonatomic, copy, nullable) NSNumber * keepPreviousSubscriptions WTL_DEPRECATED(
    "Please use replaceExistingSubscriptions",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@property (nonatomic, copy, nullable) NSNumber * autoResubscribe WTL_DEPRECATED(
    "Please use resubscribeAutomatically",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
 ...
 * own.  Uses of WTLSubscribeParams that rely on init must all be using
 * (deprecated) APIs that pass in a separate minInterval and maxInterval.
 */
- (instancetype)init WTL_DEPRECATED(
    "Please use initWithMinInterval",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
+ (instancetype)new WTL_DEPRECATED(
    "Please use initWithMinInterval",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@end
