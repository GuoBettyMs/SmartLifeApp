...
/**
 * An object that represents a fabric that the WTLDeviceControllerFactory knows
...
@interface WTLFabricInfo : NSObject
 ...
 */
@property (readonly, nonatomic, nullable) WTLCertificateDERBytes rootCertificate;

/**
 * The same root certificate as rootCertificate, in Matter TLV format.
 */
@property (readonly, nonatomic, nullable) WTLCertificateTLVBytes rootCertificateTLV;
 ...
 * access to.
 */
@property (readonly, nonatomic, nullable) WTLCertificateDERBytes intermediateCertificate;

/**
 * The same intermediate certificate as intermediateCertificate, in Matter TLV format.
 */
@property (readonly, nonatomic, nullable) WTLCertificateTLVBytes intermediateCertificateTLV;

/**
 * The operational certificate for the node.  This might be nil if
 * the node is not on a fabric we have access to.
 */
@property (readonly, nonatomic, nullable) WTLCertificateDERBytes operationalCertificate;

/**
 * The same operational certificate as operationalCertificate, in Matter TLV format.
 */
@property (readonly, nonatomic, nullable) WTLCertificateTLVBytes operationalCertificateTLV;
