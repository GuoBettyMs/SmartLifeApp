...
typedef NS_ENUM(NSUInteger, WTLOTAImageDigestType) {
    WTLOTAImageDigestTypeSha256 = 1,
    WTLOTAImageDigestTypeSha256_128,
    WTLOTAImageDigestTypeSha256_120,
    WTLOTAImageDigestTypeSha256_96,
    WTLOTAImageDigestTypeSha256_64,
    WTLOTAImageDigestTypeSha256_32,
    WTLOTAImageDigestTypeSha384,
    WTLOTAImageDigestTypeSha512,
    WTLOTAImageDigestTypeSha3_224,
    WTLOTAImageDigestTypeSha3_256,
    WTLOTAImageDigestTypeSha3_384,
    WTLOTAImageDigestTypeSha3_512,
};

@interface WTLOTAHeader : NSObject

/**
 * Initialize the WTLOTAHeader with the given Matter OTA software image data (as defined in the
 ...
 * will return nil and the caller should try creating a new WTLOTAHeader object and initializing it
 * with a larger chunk of the image.
 */
- (instancetype)initWithData:(NSData *)data API_AVAILABLE(macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, assign) WTLOTAImageDigestType imageDigestType;
...
WTL_DEPRECATED("Please use WTLOTAHeader's initWithData:",  macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
@interface WTLOTAHeaderParser : NSObject
+ (nullable WTLOTAHeader *)headerFromData:(NSData *)data error:(NSError * __autoreleasing *)error;
@end
